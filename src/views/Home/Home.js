...
import { Songs } from "../Songlist/Songs";
...
const Home = ({
  ...
  const songRoute = (data) => {
    // navigate("/movielist")
  };

  const Routepage = (item) => {
    // props.updateMusic(item.audioSrc);
    // setCurrentSong(item.audioSrc)
    navigate("/play");
  };
              ...
              <div className="screen home">
                <div className="full-new-mob">
                  <div
                    className={
                      isActive
                        ? "main-screen sidebar-close"
                        : "main-screen sidebar-close sidebar-open"
                    }
                    id="sideBar"
                  >
                    ...
                    <main className="pad-top1">
                      <div className="slick-heading">
                        ...
                        <a onClick={() => navigate("/category")}>More</a>
                      </div>
                      <Slider {...settings}>
                        {/* {newRelease.slice(0, 6).map((data, index) => ( */}
                        <div className="slide-item" onClick={() => songRoute()}>
                          <div className="popular_img">
                            {/* <img src={data._id.artwork ? data._id.artwork : re1Img} alt="" /> */}
                            <img src={re1Img} alt="" />
                          </div>
                          <p>Music Name</p>
                          {/* <p>{data._id.movie_name ? data._id.movie_name : "Music Name"}</p> */}
                        </div>
                        {/* ))} */}
                      </Slider>

                      <div className="slick-heading pt-3">
                        <h4>My Playlist</h4>
                        <a href="#">More</a>
                      </div>
                      ...
                      <div className="song-wrapper align-items-start">
                        ...
                        <div className="w-100">
                          ...
                          <div className="progress-details">
                            <h5>{getTime(songInfo.currentTime)}</h5>
                            <div className="progress">
                              <div
                                ...
                                aria-valuemin="0"
                                aria-valuemax="100"
                                style={{ width: `${songInfo.currentTime}%` }}
                              ></div>
                            </div>
                            <h5>{songInfo.duration
