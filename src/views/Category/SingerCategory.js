...
import { singerWiseList } from "../../../../../../redux/features/musicpreview";
...
const Category = (props) => {
    ...
    const { singerWise } = useSelector(state => state.musicpreview)


    useEffect(() => {
        (async () => {
            const resp1 = await dispatch(singerWiseList());
                                    ...
                                    <div className={isActive ? "main-screen sidebar-close" : "main-screen sidebar-close sidebar-open"} id="sideBar" >
                                        ...
                                        <main className="pad-top2">
                                            <div className="slick-heading">
                                                <h4>Singers Collection</h4>
                                                {/* <a href="catagory.html">
                                                    More
                                                </a> */}
                                            </div>
                                            <div className="slick_carousel more-music mt-0">
                                                {singerWise.map((data, index) => (
                                                    <div className="slide-item" onClick={() => songData(data)}>
                                                        <div className="popular_img">
                                                            <img src={data._id.singer_img ? data._id.singer_img : re1Img} alt="" />
                                                        </div>
                                                        <p>{data._id.singer_name ? data._id.singer_name : "Singer Name"}</p>
                                                    </div>
                                                ))}
                                            </div>
                                        </main>
