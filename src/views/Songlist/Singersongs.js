...
const Playlist = (props) => {
    ...
    const modArr = Musicplay.songData?.singer_details?.map(movie => {
        return { ...movie, singer_image: Musicplay.songData?._id?.singer_img, singer_name: Musicplay.songData?._id?.singer_name }
    })
                                    ...
                                    <div className={isActive ? "main-screen sidebar-close" : "main-screen sidebar-close sidebar-open"} id="sideBar" >
                                        ...
                                        <div className="main-header">
                                            <div className="flex-d">
                                                ...
                                                <button className="arrow-svg" onClick={() => navigate("/singer")}>
                                                    ...
                                                    <li className="list-song">
                                                        <a className="list-songs" data-toggle="modal" data-target="#song">
                                                            <div className="details">
                                                                <div className="thumb">
                                                                    <img src={data.singer_image ? data.singer_image : p1Img} alt="" />
                                                                </div>
                                                                <div className="details-song">
                                                                    <h5>{data.title ? data.title : "Song Name."}</h5>
                                                                    <h6>{data.singer_name ? data.singer_name : "Artist Name"} <span>{data.durationTime ? data.durationTime : "0.00"}</span> </h6>
                                                                </div>
                                                            </div>
