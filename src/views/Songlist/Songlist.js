...
const Playlist = (props) => {
    ...
    const modArr = Musicplay.songData?.movie_details?.map(movie => {
        return { ...movie, artwork: Musicplay.songData?._id?.artwork, movie_name: Musicplay.songData?._id?.movie_name }
    })

    console.log(Musicplay.songData, "modArr")
                                                    ...
                                                    <li className="list-song">
                                                        <a className="list-songs" data-toggle="modal" data-target="#song">
                                                            <div className="details">
                                                                <div className="thumb">
                                                                    <img src={data.artwork ? data.artwork : p1Img} alt="" />
                                                                </div>
